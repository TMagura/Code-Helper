    ...
    <div class="container">
        <div class="row">
            ...
            ?>
                        ...
                        <!-- First Blog Post -->
            <h2>
              Title Name:<a href="#"><?php echo strtoupper($post_title);?></a>
            </h2>
            <p class="lead">
             Written by :<a href="author_posts.php?author=<?php echo $post_author;?>&p_id=<?php echo $link_post_id;?>"><?php echo strtoupper($post_author);?></a>
            </p>
        ...
        <?php 
            if(isset($_SESSION['user_role']) ){
                ...
                echo ' 
                <div class="row">
                <p class="pull-left"><a class="Unlike" href="" data-toggle="tooltip" title="You liked it before!"><span class="glyphicon glyphicon-thumbs-down"></span> UnLike</a></p>  
                </div>';
            }else {
                echo '
                <div class="row">
                <p class="pull-left"><a class="like" href="" data-toggle="tooltip" title="Click and like!"><span class="glyphicon glyphicon-thumbs-up"></span> Like</a></p>  
                </div>';
            }
            }else { 
                echo '
                <div class="row">
                <p class="pull-left"><a href="login.php">login to pass a Like</a></p>  
                </div>';
            }
        ?> 

            <div class="row">
                <span class="pull-left">Likes:<?php echo numberOfLikes($link_post_id);?></span> 
            </div>
        ...
        ?>
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading"><small class="text-danger">From:</small><small><?php echo strtoupper($comment_author);?></small>
                            <small class="text-danger">On:</small><small><?php echo $comment_date;?></small>
                        </h4>
                        <h4><small class="text-danger">Comment :</small><i><?php echo $comment_content;?></i></h3>
                    </div>
                </div>
                <?php }}?>
                <br><br><hr>
