 <?php ob_start(); ?>
    ...
    ?>
        ...
        <div class="form-group">
           <label for="post_user_id">Author</label>   
            ...
            while($row = mysqli_fetch_assoc($users_query_author)){
                $post_users_id = $row['user_id'];
                $username= $row['username'];}
            echo "<option value='{$post_users_id}' selected>$username</option>";
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" name="post_content" id="" cols="10" rows="2" required><?php echo $post_content;?></textarea>
        </div>
