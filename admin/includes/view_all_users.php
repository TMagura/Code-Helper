        ...
        <h1 class="page-header">
             ...
             <div class="col-sm-4 col-lg-9">
                ...
                $user_role     = $row['user_role'];
                    ...
                    echo "<td><a class='btn btn-primary' href= 'users.php?changeToAdmin={$user_id}'>Admin</a></td>";
                    echo "<td><a class='btn btn-primary' href= 'users.php?changeToSubscriber={$user_id}'>Subscriber</a></td>";
                    
                    echo "<td><a class='btn btn-info' href= 'users.php?source=edit_users&u_id={$user_id}'>EDIT</a></td>";
