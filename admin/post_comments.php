...
<?php 
 ...
 ?>
        ...
        <h3 class="page-header" >
            COMMENTS TABLE FOR TITLE : <span class="text-primary"><?php echo strtoupper($post_comment_title);?></span>
        </h3>
...
<table class="table table-hover">
 ...
 while ($row = mysqli_fetch_assoc($select_all_comments_query)) { 
        ...
        echo "<tr>";
  ?>
    <td><input type="checkbox" name="checkBoxArray[]" class="checkBoxes" value="
      <?php echo $comment_id;?>"></td>
        <?php
    ...
    ?>
         <?php
        echo "<td><a class='btn btn-danger' href='post_comments.php?delete={$comment_id}&c_id=".$_GET['c_id']."'>DELETE</a></td>";
        echo "</tr>"; 
    }
 ?>
